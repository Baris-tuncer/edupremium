...
export default function RegisterPage() {
  return (
    <div className="min-h-screen relative flex items-center justify-center bg-[#FDFBF7]/80 backdrop-blur-xl overflow-hidden">
      ...
      {/* ARKA PLAN - Landing Page Ayarı (%60 Opaklık) */}
      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        ...
        <div className="mt-12 text-slate-600 text-sm font-medium">
          Zaten hesabınız var mı? <Link href="/login" className="text-[#0F172A] font-bold hover:text-[#D4AF37] transition-colors ml-1 underline decoration-slate-300 underline-offset-4">Giriş Yap</Link>
        </div>
      </div>
    </div>
  );
