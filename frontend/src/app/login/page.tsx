        ...
        <div className="relative z-10 flex flex-col justify-center px-16 text-white">
          <div className="max-w-lg">
            <blockquote className="text-2xl md:text-3xl font-display font-medium leading-relaxed mb-8">
              "Çocuğumun matematikte yaşadığı zorlukları 3 ayda aştık. 
              Öğretmen kalitesi ve takip sistemi gerçekten fark yaratıyor."
            </blockquote>
            <div className="flex items-center gap-4">
              <div className="w-14 h-14 bg-white/20 rounded-full flex items-center justify-center text-xl font-display font-semibold">
                AY
              </div>
              <div>
                <div className="font-semibold text-lg">Ayşe Yılmaz</div>
                <div className="text-navy-200">Veli, İstanbul</div>
              </div>
            </div>
          </div>
          ...
          <div className="absolute bottom-16 left-16 right-16 flex justify-between">
            <div>
              ...
              <div className="text-navy-300 mt-1">Tamamlanan Ders</div>
            </div>
            <div>
              <div className="text-4xl font-display font-bold">%98</div>
              <div className="text-navy-300 mt-1">Memnuniyet</div>
            </div>
            <div>
              <div className="text-4xl font-display font-bold">4.9/5</div>
              <div className="text-navy-300 mt-1">Ortalama Puan</div>
            </div>
          </div>
        </div>
      </div>
