...
const TeacherCarousel = ({ teachers }: { teachers: Teacher[] }) => {
  ...
  return (
    <div className="relative group/carousel w-full">
      ...
      <div ref={scrollContainerRef} className="flex gap-6 overflow-x-auto pb-8 pt-4 px-4 scrollbar-hide snap-x snap-mandatory" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
        {teachers.map((teacher) => (
          <div key={teacher.id} className="min-w-[320px] snap-center">
