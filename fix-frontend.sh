#!/bin/bash
cd ~/Desktop/edupremium/frontend

# ============================================
# 1. Dashboard - sidebar linkini düzelt (appointments -> lessons)
# ============================================
sed -i '' "s/{ id: 'appointments'/{ id: 'lessons'/g" src/app/teacher/dashboard/page.tsx

# ============================================
# 2. Profile sayfasındaki auth sorununu düzelt
# ============================================
cat > src/app/teacher/profile/page.tsx << 'PROFILEEOF'
'use client';
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            <div className="bg-white rounded-2xl shadow-card p-6">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input type="text" value={profile.firstName} disabled className="w-full px-4 py-3 rounded-xl border border-slate-200 bg-slate-50 text-slate-500 cursor-not-allowed" />
                ...
                <div>
                  ...
                  <input type="text" value={profile.lastName} disabled className="w-full px-4 py-3 rounded-xl border border-slate-200 bg-slate-50 text-slate-500 cursor-not-allowed" />
                </div>
              </div>
              <div className="mt-6">
                <label className="block text-sm font-medium text-slate-700 mb-2">Hakkımda</label>
                <textarea value={profile.bio} onChange={(e) => setProfile({...profile, bio: e.target.value})} rows={4} className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-navy-500 outline-none resize-none" placeholder="Kendinizi tanıtın..." />
              </div>
            </div>
            <div className="bg-white rounded-2xl shadow-card p-6">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input type="number" value={profile.hourlyRate} onChange={(e) => setProfile({...profile, hourlyRate: e.target.value})} className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-navy-500 outline-none" min="100" placeholder="450" />
                </div>
                <div>
            ...
            <div className="flex justify-end">
              <button type="submit" disabled={isSaving} className="bg-navy-900 text-white px-8 py-3 rounded-xl hover:bg-navy-800 font-medium disabled:opacity-50">
...
# 3. Students sayfası
# ============================================
mkdir -p src/app/teacher/students
cat > src/app/teacher/students/page.tsx << 'STUDENTSEOF'
'use client';
...
export default function StudentsPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      <TeacherSidebar activeItem="students" user={user} />
      <div className="ml-64 p-8">
        <h1 className="font-display text-3xl text-navy-900 mb-8">Öğrencilerim</h1>
        <div className="bg-white rounded-2xl shadow-card p-12 text-center">
          <svg className="w-16 h-16 mx-auto mb-4 text-slate-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
          </svg>
          <p className="text-slate-500 text-lg">Henüz öğrenciniz bulunmuyor.</p>
          <p className="text-slate-400 mt-2">Ders aldığınız öğrenciler burada görünecek.</p>
        </div>
      </div>
    </div>
  );
...
# ============================================
# 4. Feedback ana sayfa
# ============================================
cat > src/app/teacher/feedback/page.tsx << 'FEEDBACKEOF'
'use client';
...
# 5. Earnings sayfası
# ============================================
mkdir -p src/app/teacher/earnings
cat > src/app/teacher/earnings/page.tsx << 'EARNINGSEOF'
'use client';
...
export default function EarningsPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      <TeacherSidebar activeItem="earnings" user={user} />
      <div className="ml-64 p-8">
        <h1 className="font-display text-3xl text-navy-900 mb-8">Kazançlarım</h1>
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white rounded-2xl shadow-card p-6">
            <div className="text-slate-500 text-sm mb-1">Toplam Kazanç</div>
            <div className="font-display text-3xl font-bold text-navy-900">₺0</div>
          </div>
          <div className="bg-white rounded-2xl shadow-card p-6">
            <div className="text-slate-500 text-sm mb-1">Bu Ay</div>
            <div className="font-display text-3xl font-bold text-green-600">₺0</div>
          </div>
          <div className="bg-white rounded-2xl shadow-card p-6">
            <div className="text-slate-500 text-sm mb-1">Bekleyen</div>
            <div className="font-display text-3xl font-bold text-gold-500">₺0</div>
          </div>
        </div>
        <div className="bg-white rounded-2xl shadow-card p-12 text-center">
          <svg className="w-16 h-16 mx-auto mb-4 text-slate-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <p className="text-slate-500 text-lg">Henüz kazanç bulunmuyor.</p>
          <p className="text-slate-400 mt-2">Tamamlanan derslerinizden kazancınız burada görünecek.</p>
        </div>
      </div>
    </div>
  );
...
# 6. Settings sayfası
# ============================================
mkdir -p src/app/teacher/settings
cat > src/app/teacher/settings/page.tsx << 'SETTINGSEOF'
'use client';
...
export default function SettingsPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      <TeacherSidebar activeItem="settings" user={user} />
      <div className="ml-64 p-8">
        <h1 className="font-display text-3xl text-navy-900 mb-8">Ayarlar</h1>
        <div className="max-w-2xl space-y-6">
          <div className="bg-white rounded-2xl shadow-card p-6">
            <h2 className="font-semibold text-xl text-navy-900 mb-4">Hesap</h2>
            <div className="space-y-4">
              <div className="flex items-center justify-between py-3 border-b border-slate-100">
                <div>
                  <div className="font-medium text-navy-900">E-posta</div>
                  <div className="text-slate-500 text-sm">{user?.email}</div>
                </div>
              </div>
              <div className="flex items-center justify-between py-3">
                <div>
                  <div className="font-medium text-navy-900">Şifre Değiştir</div>
                  <div className="text-slate-500 text-sm">Hesap şifrenizi güncelleyin</div>
                </div>
                <button className="text-navy-600 hover:text-navy-800 font-medium">Değiştir</button>
              </div>
            </div>
          </div>
          <div className="bg-white rounded-2xl shadow-card p-6">
            <h2 className="font-semibold text-xl text-navy-900 mb-4">Oturum</h2>
            <button onClick={handleLogout} className="w-full bg-red-50 text-red-600 px-4 py-3 rounded-xl hover:bg-red-100 font-medium transition-colors">
              Çıkış Yap
            </button>
          </div>
        </div>
...
# ============================================
# 7. Dashboard sidebar linkini de düzelt
# ============================================
sed -i '' "s/{ id: 'appointments'/{ id: 'lessons'/g" src/app/teacher/dashboard/page.tsx

echo "✅ Tüm dosyalar oluşturuldu!"
echo ""
echo "Şimdi deploy ediliyor..."

# Deploy
git add -A && git commit -m "Fix all teacher pages with proper auth and sidebar" && git push origin main

echo ""
echo "✅ Deploy tamamlandı! 2 dakika bekleyip test edin."
