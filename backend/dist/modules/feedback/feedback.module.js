...
exports.FeedbackModule = FeedbackModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [feedback_service_1.FeedbackService, ai_report_service_1.AiReportService],
        exports: [feedback_service_1.FeedbackService, ai_report_service_1.AiReportService],
    })
], FeedbackModule);
