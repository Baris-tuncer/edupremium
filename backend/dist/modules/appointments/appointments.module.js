...
const appointments_processor_1 = require("./appointments.processor");
...
exports.AppointmentsModule = AppointmentsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [appointments_service_1.AppointmentsService, appointments_processor_1.AppointmentsProcessor],
